...
namespace Toggl.Foundation.MvvmCross.ViewModels
{
    ...
    public sealed class MainViewModel : MvxViewModel
    {
            ...
            IRxActionFactory rxActionFactory)
        {
            ...
            SuggestionsViewModel = new SuggestionsViewModel(timeService, dataSource, rxActionFactory, analyticsService, interactorFactory, onboardingStorage, schedulerProvider, navigationService);
