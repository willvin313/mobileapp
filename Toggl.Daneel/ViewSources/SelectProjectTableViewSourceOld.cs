...
{
    public sealed class SelectProjectTableViewSourceOld : CreateSuggestionGroupedTableViewSource<AutocompleteSuggestion>
    {
        ...
        public SelectProjectTableViewSourceOld(UITableView tableView)
