...
{
    public sealed class SplitScreenPresentationController : UIPresentationController
    {
        ...
        public SplitScreenPresentationController(UIViewController presentedViewController,
        ...
        public override void ContainerViewWillLayoutSubviews()
        {
            ...
            var shadowPath = UIBezierPath.FromRect(PresentedViewController.View.Bounds).CGPath;
        ...
        public override CGSize GetSizeForChildContentContainer(IUIContentContainer contentContainer, CGSize parentContainerSize)
        {
            ...
            var multiplier = largerSide == parentContainerSize.Width ? 0.4f : 0.33f;
            return new CGSize(largerSide * multiplier, parentContainerSize.Height);
        }
        ...
        public override CGRect FrameOfPresentedViewInContainerView
        {
            get
            {
                ...
                frame.X = containerSize.Width - frame.Size.Width;
                frame.Y = 0;
                return frame;
            }
        }
